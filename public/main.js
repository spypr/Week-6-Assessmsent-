...
const drawFive = () => {
    axios.get('http://35.91.242.6/api/robots/five')
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://35.91.242.6/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://35.91.242.6/api/player')
...
const getAllBots = () => {
    axios.get('http://35.91.242.6/api/robots')
        .then(({data}) => {
